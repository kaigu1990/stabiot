test_that("derive_bor works as expected with default arguments", {
  ...
  expect_identical(
    ...
    tibble::tibble(
      ...
      ADTC = c(
        "2020-02-01", "2020-03-13", "2020-01-01", "2020-01-01",
        "2020-02-16", "2020-02-16", "2020-02-16"
      ),
      AVALC = c("CR", "CR", "PR", "PR", "CR", "CR", "PD"),
      ADT = ymd(ADTC),
      TRTSDT = ymd(c(
        "2020-01-01", "2019-12-12", "2019-12-30", "2020-01-01",
...
test_that("derive_bor works as expected for confirmed BOR", {
  ...
  expect_identical(
    ...
    tibble::tibble(
      USUBJID = as.character(c(1:2, 4:8)),
      ADTC = c(
        "2020-02-01", "2020-02-01", "2020-05-01", "2020-01-01",
...
test_that("derive_bor works as expected with zero NE", {
  ...
  expect_identical(
    ...
    tibble::tibble(
      USUBJID = as.character(c(1:2, 4:8)),
      ADTC = c(
        "2020-01-01", "2020-02-01", "2020-05-01", "2020-01-01",
        "2020-02-06", "2020-02-06", "2020-02-16"
      ),
...
test_that("derive_bor works as expected with at least 56 days of reference interval
  ...
  expect_identical(
    ...
    tibble::tibble(
      USUBJID = as.character(c(1:2, 4:8)),
      ADTC = c(
        "2020-01-01", "2020-03-01", "2020-05-01", "2020-01-01",
